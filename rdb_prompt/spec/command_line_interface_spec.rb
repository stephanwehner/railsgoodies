...
describe RailsGoodies::RdbPrompt::CommandLineInterface, 'Experimental OptionParser Extensions' do
  it 'should work without any options' do
    command_line_interface = RailsGoodies::RdbPrompt::CommandLineInterface.new
...
describe RailsGoodies::RdbPrompt::CommandLineInterface, 'reading the database.yml file' do
  ...
  it 'should read yaml file' do
    ...
    RailsGoodies::RdbPrompt::MysqlPrompt.should_receive(:new).and_return(prompt_mock)
  ...
  it 'should look up environment in yaml file' do
    ...
    RailsGoodies::RdbPrompt::MysqlPrompt.should_receive(:new).with(*expected_init_args).and_return(mysql_prompt_mock)
    command_line_interface.perform
  end
end

describe RailsGoodies::RdbPrompt::CommandLineInterface, 'passing on options' do
...
describe RailsGoodies::RdbPrompt::CommandLineInterface, 'selecting the AbstractPrompt to invoke' do
  it 'should use PostgresqlPrompt' do
    ...
    RailsGoodies::RdbPrompt::PostgresqlPrompt.should_receive(:new).with(*expected_init_args).and_return(prompt_mock)
    command_line_interface.perform
  end
  ...
  it 'should use MysqlPrompt' do
    ...
    RailsGoodies::RdbPrompt::MysqlPrompt.should_receive(:new).with(*expected_init_args).and_return(prompt_mock)
    command_line_interface.perform
  end
  ...
  it 'should use Sqlite3Prompt' do
    ...
    RailsGoodies::RdbPrompt::Sqlite3Prompt.should_receive(:new).with(*expected_init_args).and_return(prompt_mock)
    command_line_interface.perform
  end
end
